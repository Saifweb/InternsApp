                        ...
                        <Link href="/">
                            <a className="w-full flex align-items-center py-5 border-300 border-bottom-1">
                                ...
                                <span className="ml-4 flex flex-column">
                                    ...
                                    <span className="text-600 lg:text-lg">Is karmoussa gay ?</span>
                                </span>
                            </a>
                        </Link>
                        <Link href="/">
                            <a className="w-full flex align-items-center py-5 border-300 border-bottom-1">
                                ...
                                <span className="ml-4 flex flex-column">
                                    ...
                                    <span className="text-600 lg:text-lg">Karmoussa is gay .</span>
                                </span>
                            </a>
                        </Link>
                        <Link href="/">
                            <a className="w-full flex align-items-center mb-5 py-5 border-300 border-bottom-1">
                                ...
                                <span className="ml-4 flex flex-column">
                                    ...
                                    <span className="text-600 lg:text-lg">Sayfouuun</span>
                                </span>
                            </a>
                        </Link>
                    </div>
